  ...
  <div className='container pt-3'>
   <form onSubmit={handleAddLesson}>
    ...
    <div className='d-flex justify-content-center'>
     <label className='btn btn-dark btn-block text-left mt-3'>{uploadButtonText}<input onChange={handleVideo} type='file' accept='video/*' hidden /></label>
    </div>
    
    {!uploading && values.video.Location && (
     <Tooltip title='Remove'><span onClick={handleVideoRemove} className='pt-1 pl-3'><CloseCircleFilled className='text-danger d-flex justify-content-center pt-4 pointer' /></span></Tooltip>)}
