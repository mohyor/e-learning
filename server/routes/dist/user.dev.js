...
router.post('/forgot-password', function _callee3(req, res) {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          return _context3.abrupt("return", res.status(400).send('User not found'));
...
router.post('/reset-password', function _callee4(req, res) {
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 9:
          ...
          return _context4.abrupt("return", res.status(400).send('Error! Try again.'));
